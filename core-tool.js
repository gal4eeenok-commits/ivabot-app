    ...
    try {
      if (USE_MOCK) {
        ...
        try {
          ...
          try {
            var _isInner = false;
            try { var _pu = new URL(url); _isInner = !!(_pu.pathname && _pu.pathname !== "/"); } catch (_ip) {}
            if (_isInner) {
