...
/* seeds: real search demand for this page or domain; questions are generated from them */
      ...
      (async () => {
        try {
          ...
          try { const _hoTag = ivaAirHandoff(_snapDom, url); await ivaAirTagAnswers(_snapMid, _snapDom, _snapRunId, (_hoTag && _hoTag.startedAt) || null); } catch (_tg) { console.warn("[AIR] answers not tied to the run", _tg); }
