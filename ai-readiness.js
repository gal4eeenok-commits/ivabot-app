    ...
    try {
      ...
      const _pAio = (async () => {
        try {
          ...
          if (_ao && Array.isArray(_ao.ai_overview) && _ao.ai_overview.length) {
            ...
            return { ai_overview_count: _aioCited, prompts_checked: _kws };
          }
          return null;
      ...
      (async () => {
        try {
          ...
          recordAirSnapshot({ memberId: _snapMid, domain: _snapDom, url: url, runId: _snapRunId, aiReadiness: aiReadiness, ai_mentions_count: (_mv.ai_mentions_count != null ? _mv.ai_mentions_count : null), ai_search_volume: (_mv.ai_search_volume != null ? _mv.ai_search_volume : null), ai_overview_count: (_av.ai_overview_count != null ? _av.ai_overview_count : null), prompts_checked: (_av.prompts_checked || null) });
