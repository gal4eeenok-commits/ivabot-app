/* IvaBot Content Coverage v6.5 — KD shows number + low/medium/high badge */
(function() {
const{useState,useRef,useEffect,useCallback}=React;
console.log("[IvaBot] content-coverage.js v6.5 loaded");
