/* IvaBot Content Builder v60 — max 3 keywords, keyword placement, h3 postprocess, hl full phrases only */
const{useState,useRef,useEffect,useCallback}=React;
console.log("[IvaBot] content-builder.js v60 loaded");
