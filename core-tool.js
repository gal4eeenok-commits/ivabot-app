...
async function generatePDF(data) {
  ...
  if (false /* HIDDEN until real DataForSEO endpoints (post 2026-07-01). TODO: same as on-screen — real page-level backlinks (exact count + referring domains) from Backlinks API, target = page URL. Drop "approximate". */ && data.backlinksCount != null) {
    content.push({
      columns: [
